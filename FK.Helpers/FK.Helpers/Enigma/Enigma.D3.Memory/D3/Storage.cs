...
namespace Enigma.D3
{
	public partial class Storage : MemoryObject
	{
		...
		public Ptr<MarkerManager> Markers { get { return ReadPointer<MarkerManager>(0x124); } }
		public Ptr<InactiveMarkerManager> InactiveMarkers { get { return ReadPointer<InactiveMarkerManager>(0x128); } }
		public Ptr<PlayerDataManager> PlayerDataManager { get { return ReadPointer<PlayerDataManager>(0x12C); } }
		...
		public Ptr<FastAttrib> FastAttrib { get { return ReadPointer<FastAttrib>(0x14C); } }
		public Ptr<Teams> Teams { get { return ReadPointer<Teams>(0x150); } }
		public int _x154 { get { return Read<int>(0x154); } }
		public Ptr<ActorCommonDataManager> ActorCommonDataManager { get { return ReadPointer<ActorCommonDataManager>(0x158); } }
		...
		public Ptr<QuestManager> Quests { get { return ReadPointer<QuestManager>(0x168); } }
		...
		public Ptr<ActorInventory> x178_Ptr_Allocator_96Bytes_ActorInventory { get { return ReadPointer<ActorInventory>(0x178); } }
	...
	{
		public static Storage Instance { get { return ObjectManager.Instance.IfNotNull(a => a.Storage); } }
