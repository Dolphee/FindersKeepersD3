...
namespace Enigma.D3
{
	public partial class ObjectManager : MemoryObject
	{
		...
		public Ptr<X790> x790 { get { return ReadPointer<X790>(0x790); } }
		public int _x794_int { get { return Read<int>(0x794); } }
		public Storage Storage { get { return Read<Storage>(0x798); } }
		...
		public Ptr<ExpandableContainer<Actor>> RActors { get { return ReadPointer<ExpandableContainer<Actor>>(0x958); } }
		...
		public Ptr<Container<Scene>> Scenes { get { return ReadPointer<Container<Scene>>(0x998); } }
		...
		public Ptr<UIManager> UI { get { return ReadPointer<UIManager>(0x9CC); } }
		public Ptr<CameraManager> x9D0_Ptr_5088Bytes_CameraManager { get { return ReadPointer<CameraManager>(0x9D0); } }
		public Ptr<Container<World>> CWorlds { get { return ReadPointer<Container<World>>(0x9D4); } }
		public Ptr<WorldManager> x9D8_Ptr_80Bytes_WorldManager { get { return ReadPointer<WorldManager>(0x9D8); } }
		public Ptr<Player> Player { get { return ReadPointer<Player>(0x9DC); } }
		public Ptr<PlayerInput> PlayerInput { get { return ReadPointer<PlayerInput>(0x9E0); } }
