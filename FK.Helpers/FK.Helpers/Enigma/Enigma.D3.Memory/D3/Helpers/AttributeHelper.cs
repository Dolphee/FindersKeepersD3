...
namespace Enigma.D3.Helpers
{
	...
	public static partial class Attributes
	{
        ...
        public static Attribute<int> Post212Drop2 = new SimpleAttribute<int>(AttributeId.Post212Drop2, 0);
        ...
        public static Attribute<int> ItemEquippedButDisabledDuplicateLegendary2 = new SimpleAttribute<int>(AttributeId.ItemEquippedButDisabledDuplicateLegendary, 0);
        ...
        public static Attribute<float> MultiplicativeDamagePercentBonus = new SimpleAttribute<float>(AttributeId.MultiplicativeDamagePercentBonus, 1065353216);
        public static Attribute<float> MultiplicativeDamagePercentBonusForSkill = new SimpleAttribute<float>(AttributeId.MultiplicativeDamagePercentBonusForSkill, 1065353216);
        public static Attribute<int> InSetDungeonWorld = new SimpleAttribute<int>(AttributeId.InSetDungeonWorld, 0);
        public static Attribute<float> MultiplicativeDamagePercentBonusNoPets = new SimpleAttribute<float>(AttributeId.MultiplicativeDamagePercentBonusNoPets, 1065353216);
        public static Attribute<float> MultiplicativeDamagePercentBonusAgainstCCTargets = new SimpleAttribute<float>(AttributeId.MultiplicativeDamagePercentBonusAgainstCCTargets, 1065353216);
        public static Attribute<float> MultiplicativeDamagePercentBonusAgainstSlowedTargets = new SimpleAttribute<float>(AttributeId.MultiplicativeDamagePercentBonusAgainstSlowedTargets, 1065353216);
